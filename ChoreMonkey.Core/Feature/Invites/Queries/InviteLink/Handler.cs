...
namespace ChoreMonkey.Core.Feature.Invites.Queries.InviteLink;
...
internal static class InviteLinkEndpoint
{
    ...
    {
        group.MapGet("households/{householdId:guid}/invite", async (Guid householdId, Feature.Invites.Queries.InviteLink.Handler handler) =>
        {
